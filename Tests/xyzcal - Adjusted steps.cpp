...
const int16_t xyzcal_point_xcoords[4] PROGMEM = { 920, 17160, 17160, 920 }; //Cal patern for 80steps
const int16_t xyzcal_point_ycoords[4] PROGMEM = { 560, 560, 15840, 15840 };  //Cal patern for 80steps
