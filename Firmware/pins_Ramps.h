...
//#define PINDA_THERMISTOR  //If commented Pinda thermistor disabled
...
#define X_DIR_PIN			55
#define X_MIN_PIN			3
#define X_MAX_PIN			-1 //2  // Will be eventually assigned to UVLO for RAMPS, Turn off to set Noctua FAN RPM reading
...
//#define TEMP_PINDA_PIN    15// -1 PINDA TERMISTOR TEST 
...
//#define MOTOR_CURRENT_PWM_E_PIN  -1
...
#ifdef G3D_PANEL //changed to zonestar LCD
	...
	#define TACH_0				       2//-1  //30	// noctua extruder fan, Xmax signal pin

	#define BEEPER			37//33 //-1 to disable
	...
	#define BTN_EN1                31//37
	#define BTN_EN2                33//35
	#define BTN_ENC                35//31 // the click
	#define SDCARDDETECT           49
#else
	//values for REPRAP_DISCOUNT_SMART_CONTROLLER //RAMPS all this moded to work with LCD
//values for G3D LCD panel
  #define SDPOWER             -1
  #define SDSS                53
  #define LED_PIN             -1//13
