...
#define XYZCAL_PINDA_HYST_MIN 20  //50um ZRIB Changes
#define XYZCAL_PINDA_HYST_MAX 100 //250um ZRIB Changes
#define XYZCAL_PINDA_HYST_DIF 5   //12.5um ZRIB Changes
...
#define MAX_DIAMETR 600 //Max diameter of center find ZRIB_mods
...
const int16_t xyzcal_point_xcoords[4] PROGMEM = { 918, 17558, 17558, 918 }; 
const int16_t xyzcal_point_ycoords[4] PROGMEM = {188, 188, 15548, 15548};
